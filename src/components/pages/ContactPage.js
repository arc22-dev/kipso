    ...
    return (
        ...
        <div>
                ...
                <div className="row">
                  <div className="col-lg-4">
                    <div className="contact-info-one__single">
                      ...
                      <p className="contact-info-one__text">
                        ...
                        available in the market to use <br />deliver
                        satisfaction.
                      </p>
                    </div>
                  </div>
                  <div className="col-lg-4">
                    <div className="contact-info-one__single">
                      ...
                      <p className="contact-info-one__text">
                        855 Road Broklyn Street, <br />600 New York, United
                        States of <br />
                        America
                      </p>
                    </div>
                  ...
                  <div className="col-lg-4">
                    <div className="contact-info-one__single">
                      ...
                      <p className="contact-info-one__text">
                        needhelp@example.com <br />000 888 0000 <br />
                         
                      </p>
                    </div>
                  </div>
            ...
            <iframe
              ...
              className="google-map__contact" title="Google maps"
            ></iframe>
        </div>
        <Footer></Footer>
        </>
